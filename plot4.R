...
par(mfrow=c(2,2))
plot(DTs,PowerData$Global_active_power,xlab="",ylab="Global Active Power",type="n")
lines(DTs,PowerData$Global_active_power)

plot(DTs,PowerData$Voltage ,xlab="datetime",ylab="Voltage",type="n")
lines(DTs,PowerData$Voltage)

plot(DTs,PowerData$Sub_metering_1,xlab="",ylab="Energy sub metering",type="n")
lines(DTs,PowerData$Sub_metering_1)
lines(DTs,PowerData$Sub_metering_2,col="red")
lines(DTs,PowerData$Sub_metering_3,col="blue")
legend("topright",bty="n",lty=1, col = c("black","red", "blue"), legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))

plot(DTs,PowerData$Global_reactive_power ,xlab="datetime",ylab="Global_reactive_power",type="n")
#plot(DTs,PowerData$Global_reactive_power ,pch=".",xlab="datetime",ylab="Global_reactive_power")
lines(DTs,PowerData$Global_reactive_power)
dev.off()
